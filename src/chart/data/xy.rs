...
impl XyChartData {
    /// Create a new empty XY chart data object.
    #[must_use]
    pub fn new() -> Self {
        Self {
            series: Vec::new(),
...
/// Creates an empty XY chart data set with no series.
...
/// Data for a single series in an XY chart.
#[derive(Debug, Clone)]
...
impl XySeriesData {
    /// Add a data point with X and Y values.
